...
export const PRESET_QUESTIONS: PresetQuestion[] = [
  {
    ...
    question: "114年年終工作獎金什麼時候發放？"
  },
  {
    category: LawCategory.FINANCE,
    question: "留職停薪人員的年終獎金如何計算？"
  },
  {
    category: LawCategory.FINANCE,
    question: "薪資系統發放年終時，所得歸屬年度是哪一年？"
  },
  {
    category: LawCategory.PROCUREMENT,
    question: "請問採購金額15萬元的案子，可以直接找廠商議價嗎？"
  },
  {
    category: LawCategory.DOCUMENT,
    question: "請幫我擬一份「同意同仁參加在職訓練」的簽稿。"
  }
];

export const WELCOME_MESSAGE = "同仁好，我是阿標。關於年終獎金發放、薪資系統操作、採購程序或公文撰寫有任何疑義，請隨時提出。切記，出納業務攸關同仁權益，務必精確核算。";